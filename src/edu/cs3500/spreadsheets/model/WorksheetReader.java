...
public final class WorksheetReader {
  ...
  /**
   * An implementation of the builder pattern for a spreadsheet.
   */
  public static class BasicWorksheetBuilder implements WorksheetBuilder<BasicSpreadsheetModel> {
    private BasicSpreadsheetModel model;
    public final StringBuilder errorMessages;
    ...
    public WorksheetBuilder<BasicSpreadsheetModel> createCell(int col, int row, String contents) {
      ...
      try {
        model.setCell(contents, new Coord(col, row));
      }
