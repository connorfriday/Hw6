...
/**
 * A test suite for the sum function object.
 */
public class SumTest {

  @Test (expected = IllegalArgumentException.class)
  public void testConstructorNullMap() {
    SpreadsheetFunction func = new Sum(null, new BasicSpreadsheetModel());
  }

  @Test (expected = IllegalArgumentException.class)
  public void testConstructorNullSheet() {
    SpreadsheetFunction func = new Sum(new HashMap<>(), null);
  }

  @Test (expected = IllegalArgumentException.class)
  public void evaluateAllStrings() {
    SpreadsheetFunction func = new Sum(new HashMap<>(), new BasicSpreadsheetModel());
